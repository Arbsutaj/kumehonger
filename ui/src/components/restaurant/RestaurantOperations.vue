      ...
      <md-steppers :md-active-step.sync="active" md-linear>
          ...
          <div class="row justify-content-center ">
            <div class="mt-4 mb-4 create-form">
              ...
              <div class="d-flex justify-content-center">
                <vs-button danger border v-on:click="cancelRestaurant()">
                  Cancel
                </vs-button>
                <vs-button v-on:click="saveRestaurant()" success border>
                  Save
                </vs-button>
                <vs-button v-on:click="goToMenuTab()" v-if="restaurant.id" warn
                           border>
                  Next
                </vs-button>
              </div>
        ...
        <md-step id="second" md-label="Add menu" :md-done.sync="second">
          ...
          <div class="d-flex justify-content-center mt-3">
            <vs-button danger v-on:click="cancelMenu()">
              Cancel
            </vs-button>
            <vs-button v-on:click="saveMenus()">
              Save
            </vs-button>
          </div>
        </md-step>
...
import {CreateRestaurantRequest} from "./models/create-restaurant-request";
import {Menu} from "@/components/restaurant/models/menu";
