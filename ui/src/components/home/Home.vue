<template>
  <div>
    ...
    <div class="more-ingredients-banner section-padding-menu text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
      ...
      <div class="container">
        ...
        <div v-for="(menu, i) in menus" :key="i">
          ...
          <div class="row mt-5" v-if="menu[1]">
            <div class="col-lg-3 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
